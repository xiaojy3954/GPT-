...
namespace AUZT_Authorization
{
   public class DB
    {   //数据库连接字符串(web.config来配置)，可以动态更改connectionString支持多数据库.		
       public static string connectionString = sqlhelper.Decrypt(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString,"佳阳sama赛高");
        public DB() { }
        ...
        public static int GetMinID(string FieldName, string TableName)
        {
            ...
            object obj = DB.GetSingle(strsql);
            if (obj == null)
            {
                return 0;
            }
        ...
        {
            object obj = DB.GetSingle(strSql, cmdParms);
            int cmdresult;
            if ((Object.Equals(obj, null)) || (Object.Equals(obj, System.DBNull.Value)))
            {
                cmdresult = 0;
        ...
        public static bool CheckLink(string StrCon)
        {
            try
            {
